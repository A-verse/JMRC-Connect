...
const quickLinks = [
  {
    ...
    description: "Plan route, check fare & time",
    icon: Train,
    color: "bg-secondary",
  },
  {
  ...
  },
  {
    path: "/stations",
    label: "Stations",
    description: "Facilities & nearby places",
    icon: MapPin,
    color: "bg-success",
  },
  {
    path: "/tourism",
    label: "Tourism",
    description: "Explore Jaipur via metro",
    icon: Landmark,
    color: "bg-info",
  },
  {
  ...
  },
  {
    ...
    description: "Report issues or feedback",
    icon: MessageSquare,
    color: "bg-metro-slate",
  },
];
  ...
  return (
    <div>
      ...
      <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 lg:pt-8 pb-12 lg:pb-16 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-white/70 max-w-lg mb-8 leading-relaxed">
                Plan routes, track trains, recharge smart cards, and explore the
                Pink City — powered by Jaipur Metro Rail Corporation since 2015.
              </p>
              <div className="flex flex-wrap gap-3">
                <Link to="/journey-planner">
                  <Button
                    size="lg"
                    className="bg-accent text-accent-foreground hover:bg-accent/90 text-base font-semibold gap-2 h-12 px-6 shadow-lg shadow-accent/30"
                  >
                ...
                <Link to="/metro-map">
                  <Button
                    size="lg"
                    variant="outline"
                    className="text-base font-semibold border-white/30 text-white bg-white/10 h-12 px-6 backdrop-blur-sm"
                  >
                    View Metro Map
                  </Button>
                </Link>
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to="/alerts">
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-warning hover:text-warning gap-1 shrink-0"
                >
                ...
                <Link key={link.path} to={link.path} className="group">
                  <Card className="h-full hover:shadow-lg hover:-translate-y-1 transition-all duration-200 border-border/50">
                    <CardContent className="p-5 text-center">
                      <div
                        className={`w-12 h-12 ${link.color} rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform shadow-sm`}
                      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4 leading-relaxed">
                The Jaipur Metro is a rapid transit system serving Jaipur,
                Rajasthan's capital city. Established on {jmrcInfo.established},
                JMRC began commercial operations on {jmrcInfo.commercialService}
                . It is the{" "}
                <strong className="text-foreground">
                  first metro in India to run on a triple-storey elevated road
                  and metro track
                </strong>
                .
              </p>
              <p className="text-muted-foreground mb-6 leading-relaxed">
                The Pink Line (East–West Corridor) runs{" "}
                {jmrcInfo.totalNetworkLength} from Mansarovar to Badi Chaupar
                across 11 stations, connecting key areas including Railway
                Station, Sindhi Camp, and the historic walled city.
              </p>
                ...
                {[
                  ...
                  <div key={i} className="flex gap-3 items-start">
                    <div className="flex flex-col items-center">
                      <div
                        className={`w-3 h-3 rounded-full ${phase.color} shrink-0 mt-1`}
                      />
                      {i < 4 && (
                    ...
                    <Card className="flex-1">
                      <CardContent className="p-4">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {phase.route} · {phase.length} · {phase.stations}{" "}
                          station{phase.stations > 1 ? "s" : ""}
                        </p>
                        {"opened" in phase && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Pink Line operational · Orange Line planned
              </p>
            </div>
            <Link to="/metro-map">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {line.stations.length} stations · {line.length} ·{" "}
                            {line.corridor}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center gap-1 overflow-x-auto pb-1">
                      {line.stations.map((s, i) => (
                        <div key={s.id} className="flex items-center shrink-0">
                          ...
                          />
                          <span className="text-[10px] text-muted-foreground mx-1 whitespace-nowrap">
                            {s.name}
                          </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Discover top attractions accessible from Pink Line stations
              </p>
            </div>
            <Link to="/tourism">
              <Button variant="outline" size="sm" className="gap-1">
            ...
            {touristSpots.slice(0, 4).map((spot) => (
              ...
              >
                <div className="h-44 bg-muted overflow-hidden relative">
                  ...
                  <span className="absolute bottom-3 left-3 bg-white/90 text-foreground text-[10px] font-semibold backdrop-blur-sm px-2 py-0.5 rounded-full">
                    {spot.category}
                  </span>
                </div>
                <CardContent className="p-4">
                  ...
                  <Link to={`/journey-planner?to=${spot.nearestStationId}`}>
                    <Button
                      size="sm"
                      className="w-full bg-accent text-accent-foreground hover:bg-accent/90 gap-1 h-9"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
                Ride Smarter with JMRC Card
              </h2>
              <p className="text-muted-foreground mb-4 text-lg leading-relaxed">
                Get 15% discount on every journey with Store Value smart cards.
                Also available: JMRC/HDFC Bank co-branded cards and Tourist
                cards for 1-day or 3-day unlimited travel.
              </p>
              <ul className="text-sm text-muted-foreground space-y-2 mb-6">
                <li className="flex items-center gap-2">
                  <CreditCard className="w-4 h-4 text-accent" /> Store Value
                  cards for regular commuters
                </li>
                <li className="flex items-center gap-2">
                  <CreditCard className="w-4 h-4 text-accent" /> Tourist cards —
                  1 day & 3 day unlimited travel
                </li>
                <li className="flex items-center gap-2">
                  <CreditCard className="w-4 h-4 text-accent" /> Available at
                  all station counters
                </li>
              </ul>
            ...
            <div className="flex justify-center">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-primary via-primary to-secondary rounded-2xl p-7 text-white w-80 shadow-2xl">
                  ...
                  <p className="text-xl font-mono font-bold tracking-[0.15em] mb-8">
                    4532 8890 XXXX
                  </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Stay updated with metro news and updates
              </p>
            </div>
          ...
          <div className="relative rounded-2xl overflow-hidden">
            ...
            <div className="relative text-center py-14 px-6">
              ...
              <p className="text-white/80 mb-8 max-w-lg mx-auto">
                File a complaint or share feedback about your metro experience.
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                <Link to="/complaints">
                  <Button
                    size="lg"
                    className="bg-white text-accent hover:bg-white/90 gap-2 shadow-lg font-semibold"
                  >
                ...
                <Link to="/track-complaint">
                  <Button
                    size="lg"
                    variant="outline"
                    className="gap-2 border-white/30 text-white bg-white/10 font-semibold"
                  >
