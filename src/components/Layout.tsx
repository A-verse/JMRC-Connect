      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            />
            <div>
              <h1 className="text-primary-foreground text-base font-bold leading-none">
                JMRC
              </h1>
              <p className="text-primary-foreground/60 text-[10px] font-medium tracking-wider uppercase">
                Jaipur Metro
              </p>
            </div>
          </Link>
          ...
          <nav className="px-4 py-3 space-y-1">
            ...
            <div className="pt-2 border-t border-primary-foreground/10 space-y-1">
              <Link
                to="/track-complaint"
                onClick={() => setMobileOpen(false)}
                className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-primary-foreground/70 hover:bg-primary-foreground/10"
              >
              ...
              <Link
                to="/admin"
                onClick={() => setMobileOpen(false)}
                className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium bg-accent text-accent-foreground mt-2"
              >
                Admin Dashboard
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-primary-foreground/60 leading-relaxed">
              Jaipur Metro Rail Corporation Ltd. — India's first metro on a
              triple-storey elevated road. Serving Jaipur since 3 June 2015.
            </p>
          </div>

          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider text-primary-foreground/40 mb-4">
              Services
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-primary-foreground/70">
              <li className="flex items-center gap-2">
                <Phone className="w-3.5 h-3.5 text-accent" /> 0141-2822100
              </li>
              <li className="flex items-center gap-2">
                <Phone className="w-3.5 h-3.5 text-accent" /> 1800-180-6060
                (Toll Free)
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-center gap-2">
                <Building2 className="w-3.5 h-3.5 text-accent" /> Khanij Bhavan,
                C-Scheme, Jaipur
              </li>
            </ul>
          </div>
